...
[idx, C, sumd, D] = kmeans(training_data(:, 2:131), 25, "Replicates",30,'Distance', 'correlation', 'Start','uniform' ); 

array_division_centroid_1 = training_data(idx==1); 
centroid_number_test_1 = mean(array_division_centroid_1(:, 1));

array_division_centroid_2 = training_data(idx==2); 
centroid_number_test_2 = mean(array_division_centroid_2(:, 1));

array_division_centroid_3 = training_data(idx==3); 
centroid_number_test_3 = mean(array_division_centroid_3(:, 1));

array_division_centroid_4 = training_data(idx==4); 
centroid_number_test_4 = mean(array_division_centroid_4(:, 1));

array_division_centroid_5 = training_data(idx==5); 
centroid_number_test_5 = mean(array_division_centroid_5(:, 1));

array_division_centroid_6 = training_data(idx==6); 
centroid_number_test_6 = mean(array_division_centroid_6(:, 1));

array_division_centroid_7 = training_data(idx==7); 
centroid_number_test_7 = mean(array_division_centroid_7(:, 1));

array_division_centroid_8 = training_data(idx==8); 
centroid_number_test_8 = mean(array_division_centroid_8(:, 1));

array_division_centroid_9 = training_data(idx==9); 
centroid_number_test_9 = mean(array_division_centroid_9(:, 1));

array_division_centroid_10 = training_data(idx==10); 
centroid_number_test_10 = mean(array_division_centroid_10(:, 1));

array_division_centroid_11 = training_data(idx==11); 
centroid_number_test_11 = mean(array_division_centroid_11(:, 1));

array_division_centroid_12 = training_data(idx==12); 
centroid_number_test_12 = mean(array_division_centroid_12(:, 1));

array_division_centroid_13 = training_data(idx==13); 
centroid_number_test_13 = mean(array_division_centroid_13(:, 1));

array_division_centroid_14 = training_data(idx==14); 
centroid_number_test_14 = mean(array_division_centroid_14(:, 1));

array_division_centroid_15 = training_data(idx==15); 
centroid_number_test_15 = mean(array_division_centroid_15(:, 1));

array_division_centroid_16 = training_data(idx==16); 
centroid_number_test_16 = mean(array_division_centroid_16(:, 1));

array_division_centroid_17 = training_data(idx==17); 
centroid_number_test_17 = mean(array_division_centroid_17(:, 1));

array_division_centroid_18 = training_data(idx==18); 
centroid_number_test_18 = mean(array_division_centroid_18(:, 1));
